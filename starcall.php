...
function make_gift_array($params,$currentUser,$userIsAdmin) {
  ...
  function submit_gift() {
      ...
      // This function needs to upload the file to the server and also add a
      // record in the wpsc_rq_gifts database.

      // Do the upload first - modified this code from a tut on w3schools :-)

      $target_dir = ABSPATH . "wp-content/gallery/" . $_POST['requestId'] . '/';
      ...
      if ()$uploadOk) {
          ...
          // Add the gift to the gift table
          $table = 'wpsc_rq_gifts';
          // Initial status
          $giftStatus = 'submitted';
          ...
          // Add the gift to the NGG gallery
      }
