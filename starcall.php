...
class starcall_rest extends WP_REST_Controller {
  ...
  // Register our REST Server
    ...
    // a request with a specific ID, it is always generated by the database. If the ID passed in the JSON does not exist,
    // post_requests returns false. A successful update will return true, otherwise false.
    //
...
wp_register_script('starcall_browser', plugins_url('js/browser.js', __FILE__), array('jquery','wp-api'),'1.0', true);
